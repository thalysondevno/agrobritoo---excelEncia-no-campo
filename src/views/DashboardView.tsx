...
interface DashboardViewProps {
  onBack: () => void;
  navigateTo: (view: ViewState) => void; // Adicionar navigateTo
}

const DashboardView: React.FC<DashboardViewProps> = ({ onBack, navigateTo }) => {
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="glass p-6 rounded-2xl border border-primary/20 space-y-4">
            ...
            <button 
              ...
              className="w-full py-3 bg-primary text-bg-dark font-black rounded-xl hover:bg-secondary transition-all"
            >
              Criar Novo Blog
            </button>
            <button 
